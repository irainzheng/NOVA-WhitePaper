...
| 文件 | 章节 | 用途 |
|------|------|------|
| [en/whitepaper.html](./en/whitepaper.html) | 〇.八–〇.九 | **完整英文版**（87 章节 ID 同步） |
| [ci/build_en_whitepaper.py](./ci/build_en_whitepaper.py) | 〇.九 | 中文→英文完整版生成 |
...
python docs/ci/build_en_whitepaper.py   # 章节变更后重建英文版
